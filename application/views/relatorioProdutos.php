...
<body>
		...
		<!-- Banner -->
			<section class="banner full">
				<article>
					<img src="<?php echo base_url('assets/imagens/acessorios.jpg');?>" alt="" />
					<div class="inner">
						<header>
	...
	<div class='container my-5'> 
        <div class='row mb-5'> 
            ...
            <div class='col-lg-3 col-sm-6'>
                <div class='card h-100'>
                    <img class='card-img-top' src="<?php echo base_url('assets/imagens/capBack.jpg');?>"> 
                    <div class='card-body'> 
                        <h4 class='card-title text-center mb-2'>nome</h4>
                        <br>
                        <h6 class='card-subtitle text-justify'>descricao 
            ...
            <div class='col-lg-3 col-sm-6'> 
                <div class='card h-100'> 
                    <img class='card-img-top' src="<?php echo base_url('assets/imagens/hat.png');?>"> 
                    <div class='card-body'>
                        <h4 class='card-title text-center mb-2'>nome</h4>
                        <br>
                        <h6 class='card-subtitle text-justify'>descricao 
            ...
            <div class='col-lg-3 col-sm-6'> 
                <div class='card h-100'> 
                    <img class='card-img-top' src="<?php echo base_url('assets/imagens/hat2.png');?>"> 
                    <div class='card-body'>
                        <h4 class='card-title text-center mb-2'>nome</h4> 
                        <br>
                        <h6 class='card-subtitle text-justify'>descricao
    ...
    <div class='container my-5'> 
        <div class='row mb-5'> 
            ...
            <div class='col-lg-3 col-sm-6'>
                <div class='card h-100'> 
                    <img class='card-img-top' src="<?php echo base_url('assets/imagens/acessorios4.jpg');?>"> 
                    <div class='card-body'> 
                        <h4 class='card-title text-center mb-2'>nome</h4>
                        <br>
                        <h6 class='card-subtitle text-justify'>descricao
            ...
            <div class='col-lg-3 col-sm-6'>
                <div class='card h-100'>
                    <img class='card-img-top' src="<?php echo base_url('assets/imagens/acessorios5.jpg');?>"> 
                    <div class='card-body'> 
                        <h4 class='card-title text-center mb-2'>nome</h4>
                        <br>
                        <h6 class='card-subtitle text-justify'>descricao
            ...
            <div class='col-lg-3 col-sm-6'> 
                <div class='card h-100'> 
                    <img class='card-img-top' src="<?php echo base_url('assets/imagens/tenis.jpg');?>"> 
                    <div class='card-body'>
                        <h4 class='card-title text-center mb-2'>nome</h4>
                        <br>
                        <h6 class='card-subtitle text-justify'>descricao
            ...
            <div class='col-lg-3 col-sm-6'> 
                <div class='card h-100'> 
                    <img class='card-img-top' src="<?php echo base_url('assets/imagens/ft8.jpg');?>"> 
                    <div class='card-body'>
                        <h4 class='card-title text-center mb-2'>nome</h4>
                        <br>
                        <h6 class='card-subtitle text-justify'>descricao
