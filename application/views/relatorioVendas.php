                ...
                <div class="signup-form">
                    <form class="register-form row g-2 center" action="" method="POST" id="relatorioVendas">
                        <div class="col-auto">
                            ...
                            <input class="form-control mr-sm-2" type="text" name="dataVenda" id="dataVenda" placeholder="01/01/2020"/>
                        </div>
                ...
                <div class="row col-12 max-heigh mb-4 containerEstoque ml-auto mr-auto mt-4">
                    <div class="row col-12 CardEstoque">
                        ...
                        <div class="col-4">
                            ...
                            <p class="mt-2 textEstoque">Preço Unitário:</p>
                            <p class="mt-4 align-bottom textEstoque">Preço Final:</p>
